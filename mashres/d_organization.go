...
var OrganizationDataSource *SingularDatasourceTemplate[tfmapper.Orphan, string, masherytypes.Organization] = CreateSingularDataSource(mashschemag.OrganizationResourceSchemaBuilder, queryOrganization)
